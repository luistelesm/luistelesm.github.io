...
<summary>Abstract</summary>
  ...
  Mortgage principal repayments make up 30% of yearly household saving in the euro area, where mortgage contracts typically impose rigid amortization schedules. I develop a life-cycle model with uninsurable income risk and illiquid home equity, where deviating from scheduled repayment is costly, leading constrained homeowners to cut consumption and liquid saving. In Euro-area micro data, most homebuyers start with large mortgages and little cash. They save more than renters (including debt repayment) but accumulate less liquid wealth—except in the Netherlands, where repayment was highly flexible until a 2013 policy change. I use the model, disciplined to life-cycle patterns in debt repayment and liquid wealth, to estimate the effects of this policy. Mandatory amortization increases the share of hand-to-mouth households by 15 percentage points, raising consumption volatility and marginal propensities to consume, and amplifying financial wealth inequality. Welfare losses, at 2–3% of lifetime consumption, are concentrated among lower-wealth households.<br><br>
