...
<summary>Abstract</summary>
 ...
 Mortgage repayments account for 25% of household saving flows in the Euro area. Much of this saving is not chosen freely, but constrained by rigid mortgage structures: mandatory amortization schedules induce wealth accumulation through debt repayment, but limit consumption smoothing. I develop a life-cycle model where deviating from scheduled repayment is costly, showing how binding schedules generate large responses through standard precautionary motives. In the data, younger and lower-income mortgaged homeowners in the Euro area save substantially more than renters – except in the Netherlands, where more flexible contracts are available. I calibrate the model to Dutch data spanning a 2013 policy change that increased the cost of this flexibility for new homebuyers, matching observed debt repayment and liquid wealth patterns over the life cycle and across permanent-income classes. The model shows how mandatory amortization raises total saving but crowds out liquid wealth, especially for lower-income groups. Applying the 2013 policy to pre-2013 homebuyers would increase the share of hand-to-mouth households – those with small liquid wealth buffers – by 15 percentage points, raising consumption volatility and marginal propensities to consume. Welfare losses are substantial—equivalent to 2-3% of lifetime consumption—and concentrated among lower-wealth households who value payment flexibility most. Mandatory amortization, unavoidable in most countries, reduces homeowners’ ability to smooth consumption, amplifying financial wealth inequality.<br><br>
